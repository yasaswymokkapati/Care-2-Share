...
export default class Book extends React.Component {
  ...
  gs(){
    alert("Address: NH16, Prasadampadu, currency nagar, Vijayawada, Andhra Pradesh 521108")
  }
  zps(){
    alert("Address: Kalidindi Vari Street, Kanuru, Vijayawada, Andhra Pradesh 520007")
  }
  scc(){
    alert("Address: Karl Marx Rd, Machavaram, Vijayawada, Andhra Pradesh 520004; Ph No. : 0866 244 1092")
  }
  render() {
    return (
      <View>
        <ImageBackground
          source={require('../old map.png')}
